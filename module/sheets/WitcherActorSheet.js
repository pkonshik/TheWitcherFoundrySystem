...
export default class WitcherActorSheet extends ActorSheet {
  ...
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      ...
      width: 1120,
      height: 600,
      template: "systems/witcher/templates/sheets/actor/actor-sheet.html",
  ...
  getData() {
    ...
    data.useAdrenaline = game.settings.get("witcher", "useOptionnalAdrenaline")
    data.displayRollDetails = game.settings.get("witcher", "displayRollsDetails")
    data.useVerbalCombat = game.settings.get("witcher", "useOptionnalVerbalCombat")
    data.displayRep = game.settings.get("witcher", "displayRep")
  ...
  async _onAddModifier(event) {
    ...
    switch (stat) {
      ...
      case "woundThreshold": this.actor.update({ 'system.coreStats.woundThreshold.modifiers': newModifierList }); break;
  ...
  async _onModifierEdit(event) {
    ...
    switch (stat) {
      ...
      case "woundThreshold": this.actor.update({ 'system.coreStats.woundThreshold.modifiers': modifiers }); break;
  ...
  async _onModifierRemove(event) {
    ...
    switch (stat) {
      ...
      case "woundThreshold": this.actor.update({ 'system.coreStats.woundThreshold.modifiers': newModList }); break;
  ...
  async _onVerbalCombat() {
    let displayRollDetails = game.settings.get("witcher", "displayRollsDetails")
    const dialogTemplate = await renderTemplate("systems/witcher/templates/sheets/verbal-combat.html");
    new Dialog({
  ...
  _onStatModifierDisplay(event) {
    ...
    switch (stat) {
      ...
      case "woundThreshold": this.actor.update({ 'system.coreStats.woundThreshold.isOpened': this.actor.system.coreStats.woundThreshold.isOpened ? false : true }); break;
