...
function updateDerived(actor) {
	...
	thisActor.system.coreStats.woundThreshold.modifiers.forEach(item => wtTotalModifiers += Number(item.value));
	...
	else if (HPvalue < thisActor.system.coreStats.woundThreshold.current > 0) {
		isWounded = true
